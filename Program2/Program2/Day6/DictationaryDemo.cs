...
namespace Program2.Day6
{
    ...
    class DictationaryDemo
    {
        ...
        public static void EmpDictionaryDemo()
        {
            ...
            Emp e1 = new Emp() { ID = 12345, FirstName = "Venkat", Salary = 1000000 };
            empMap.Add(15, e1);
            empMap.Add(16, e1);
        ...
        public static void TestSortedListOfEmp()
        {
            ...
            Random r1 = new Random();
            Emp e1 = new Emp() { ID = r1.Next(100), FirstName = "John", Salary = r1.NextDouble() * 5000 };
            Emp e2 = new Emp() { ID = r1.Next(100), FirstName = "Sam", Salary = r1.NextDouble() * 5000 };
            Emp e3 = new Emp() { ID = r1.Next(100), FirstName = "Ajith", Salary = r1.NextDouble() * 5000 };
            Emp e4 = new Emp() { ID = r1.Next(100), FirstName = "Ellango", Salary = r1.NextDouble() * 5000 };
            Emp e5 = new Emp() { ID = r1.Next(100), FirstName = "Basker", Salary = r1.NextDouble() * 5000 };
